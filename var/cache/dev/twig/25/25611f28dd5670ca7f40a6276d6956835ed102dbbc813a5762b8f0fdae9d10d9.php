...
class __TwigTemplate_a464237f04ef31991698c416837efa41523714cc222a0ed4246618624fcfa4db extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"error\">
  ...
  <div class=\"error__description\">Cette url n'est pas sur terre.</div>
  <a href=\"";
        // line 21
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_pdf_home");
        echo "\"><button class=\"error__button error__button--active\">MENU</button></a>
</div>
...
";
    ...
    {
        return array (  106 => 21,  88 => 5,  78 => 4,  59 => 2,  36 => 1,);
    }
...
<div class=\"error\">
  ...
  <div class=\"error__subtitle\">Hmmm...</div>
  <div class=\"error__description\">Cette url n'est pas sur terre.</div>
  <a href=\"{{ path('app_pdf_home') }}\"><button class=\"error__button error__button--active\">MENU</button></a>
</div>
...
{% endblock %}", "@Twig/Exception/error404.html.twig", "C:\\wamp64\\www\\ChancelleriePDFGenerator\\templates\\bundles\\TwigBundle\\Exception\\error404.html.twig");
    }
}
